...
class SystemMixin:
            ...
            json.dumps(
                {
                    ...
                    "kws_enabled": getattr(config, "XIAO6_KWS_ENABLED", "true").lower() in ("1", "true", "yes"),
    ...
    def _handle_config_post(self):
        ...
        allowed = {
            ...
            "Xiao6_TTS_RATE",
            "XIAO6_TTS_BACKEND",
            "XIAO6_GPT_SOVITS_URL",
            "XIAO6_GPT_SOVITS_REF",
            "XIAO6_GPT_SOVITS_PROMPT",
            "XIAO6_PROXY_URL",
            "XIAO6_WEB_SEARCH_KEY",
            "XIAO6_WEB_SEARCH_ENGINE",
            "XIAO6_MEDIA_PROVIDER",
            "MINIMAX_API_KEY",
            "MINIMAX_GROUP_ID",
            "XIAO6_ASR_PROVIDER",
            "ALIYUN_ASR_KEY",
            ...
            "XIAO6_SANDBOX_EXEC",
            "XIAO6_BLOCKED_TOOLS",
            "XIAO6_WEB_SEARCH_SERPER_KEY",
            "XIAO6_WEB_SEARCH_JINA_KEY",
            "XIAO6_WEB_SEARCH_BRAVE_KEY",
            "XIAO6_WEB_SEARCH_SEARXNG_URL",
            "LLM2_BASE_URL",
            "LLM2_API_KEY",
            "LLM2_MODEL",
            "LLM2_PROVIDER",
            ...
            "XIAO6_KWS_ENABLED",
            "XIAO6_WAKE_PHRASE",
            "XIAO6_KWS_SENSITIVITY",
            "XIAO6_VOSK_KWS_ENABLED",
            "XIAO6_DOC_DIR",
            "XIAO6_AUTO_REVIEW",
