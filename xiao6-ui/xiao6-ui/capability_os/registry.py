#!/usr/bin/env python3
"""Xiao6 · 能力操作系统 · 统一能力注册表（Capability Registry）—— Phase 23.1
...
纪律（严格复用，禁新建）：
- 本文件【不执行任何能力】。它只描述「Xiao6拥有哪些能力、各自用途、风险、权限、
...
def _product_catalog() -> List[Capability]:
    return [
        Capability(
            ...
            description="语音识别（ASR）与语音合成（TTS），让Xiao6能听能说。",
        ...
        Capability(
            ...
            description="短期对话记忆、长期记忆沉淀与重要性召回，让Xiao6记得你。",
            risk=Risk.LOW, permission=Permission.AUTO,
        ...
        Capability(
            ...
            description="目标与任务管理，Xiao6据此自主拆解并执行多步任务。",
            risk=Risk.LOW, permission=Permission.AUTO,
        ...
        Capability(
            ...
            description="实时热点、热榜与新闻预取，让Xiao6紧跟时事。",
            risk=Risk.LOW, permission=Permission.AUTO,
